...
object FakeDB {
    ...
    // fake students
    val student1 =
        StudentModel(1, "Jassika", "jassika@torontomu.ca", "I am studying Java")
    val student2 = StudentModel(2, "Maya", "Maya@torontomu.ca", "Into fashion")
    val student3 = StudentModel(3, "Nima", "Nima@torontomu.ca", "World of Dinosaurs")
    val student4 = StudentModel(4, "Choney", "cdolma@torontomu.ca", "Anybody up for bakery?")
    ...
    // fake groups
    val group1 = GroupModel(1, "DBMS", "Working on AI project; looking for two more members form CS.", students)
    val group2 = GroupModel(2, "Java and OOPS", "Learning cool things Android Studio, anybody interested to collaborate?", students)
    val group3 = GroupModel(3, "Data structure", "Need help with Tree structure assignment.", students)
    val group4 = GroupModel(4, "A.I", "Learning and growing; looking for group study", students)
